function NavIcon({ type, clickHandler, active, loggedIn }) {
  const twitter_icon = (
    <svg
      viewBox="0 0 24 24"
      aria-hidden="true"
      className={
        active ? "nav-icon active home-button" : "nav-icon home-button"
      }
    >
      <g>
  ...
  const explore_icon = (
    <svg
      ...
      aria-hidden="true"
      className={
        active ? "nav-icon active explore-icon" : "nav-icon explore-icon"
      }
    >
      <g>
  ...
  const notifications_icon = (
    <svg
      ...
      className={
        active
          ? "nav-icon active notifications-icon"
          : "nav-icon notifications-icon"
      }
    >
      <g>
  ...
  const messages_icon = (
    <svg
      ...
      aria-hidden="true"
      className={
        active ? "nav-icon active messages-icon" : "nav-icon messages-icon"
      }
    >
      <g>
  ...
  const bookmarks_icon = (
    <svg
      ...
      aria-hidden="true"
      className={
        active ? "nav-icon active bookmarks-icon" : "nav-icon bookmarks-icon"
      }
    >
      <g>
  ...
  const lists_icon = (
    <svg
      viewBox="0 0 24 24"
      aria-hidden="true"
      className={active ? "nav-icon active lists-icon" : "nav-icon lists-icon"}
    >
      <g>
  ...
  const profile_icon = (
    <svg
      ...
      aria-hidden="true"
      className={
        active ? "nav-icon active profile-icon" : "nav-icon profile-icon"
      }
    >
      <g>
  ...
  const more_icon = (
    <svg
      viewBox="0 0 24 24"
      aria-hidden="true"
      className={active ? "nav-icon active" : "nav-icon more-icon"}
    >
      <g>
  ...
  const settings_icon = (
    <svg
      viewBox="0 0 24 24"
      aria-hidden="true"
      className={active ? "nav-icon active" : "nav-icon settings-icon"}
    >
      <g>
  ...
  function createEntry(icon, description) {
    return (
      <div className="icon-wrapper" onClick={() => clickHandler(type)}>
  ...
  switch (type) {
    ...
    case "home":
      return loggedIn ? createEntry(home_icon, "Home") : "";
    case "explore":
      return createEntry(explore_icon, "Explore");
    case "notifications":
      return loggedIn ? createEntry(notifications_icon, "Notifications") : "";
    case "messages":
      return loggedIn ? createEntry(messages_icon, "Messages") : "";
    case "bookmarks":
      return loggedIn ? createEntry(bookmarks_icon, "Bookmarks") : "";
    case "lists":
      return loggedIn ? createEntry(lists_icon, "Lists") : "";
    case "profile":
      return loggedIn ? createEntry(profile_icon, "Profile") : "";
    case "more":
      return loggedIn ? createEntry(more_icon, "More") : "";
    case "settings":
      return !loggedIn ? createEntry(settings_icon, "Settings") : "";
  }
}
