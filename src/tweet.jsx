...
function Tweet({tweet}){
    ...
    <div className="tweet-container">
        ...
        <b className="tweet-username">{tweet.userName}</b>
        <b className="tweet-timestamp">{calculateTime(tweet.timeStamp)}</b>
        <b className="tweet-options" onClick={handleTweetOptions}>...</b>
        <br/>
